...
def eliminar_usuario(db: DBSession, id_usuario: int, usuario: UsuarioActual):
...
def actualizar_rol(db: DBSession, payload: ActualizarRol, id_usuario: int, usuario: UsuarioActual):
...
def actualizar_permisos(db: DBSession, payload: ActualizarPermisos, id_usuario: int, usuario: UsuarioActual):
...
def usuario_activo(db: DBSession, payload: UsuarioActivo, id_usuario: int, usuario: UsuarioActual):
